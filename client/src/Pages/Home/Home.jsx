  ...
  return (
    <>
      ...
      <motion.div
        ref={topFoodRef}
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: topFoodInView ? 1 : 0, y: topFoodInView ? 0 : 50 }}
      ...
      <motion.div
        ref={offerRef}
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: offerInView ? 1 : 0, y: offerInView ? 0 : 50 }}
      ...
      <motion.div
        ...
        initial={{ opacity: 0, y: 50 }}
        animate={{
          opacity: chouseUsInView ? 1 : 0,
          y: chouseUsInView ? 0 : 50,
        }}
