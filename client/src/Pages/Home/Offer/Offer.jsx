            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <p className="pt-6 font-semibold text-xl text-ferris-sec">Keep our token that provided by us after completing your meal.</p>
                        <p className="py-3 text-ferris-sec/50 font-bold">We provide a random offer in every month in a random day!!! If you carry our token that previously received you in those random day, you will be the lucky one and get this special offer </p>
