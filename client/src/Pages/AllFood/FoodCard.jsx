...
const FoodCard = ({ food }) => {
  return (
    <div className="group font-jost bg-white shadow-lg  overflow-hidden sm:max-w-sm transition-transform duration-300">
      <div className="overflow-hidden relative">
        <img
          src={food.img}
          alt={food.foodName}
          className="w-full h-64 lg:h-80 object-cover object-center transition-transform duration-300 group-hover:scale-110"
        />
      </div>
