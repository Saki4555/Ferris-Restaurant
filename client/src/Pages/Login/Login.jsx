  ...
  return (
    <>
      ...
      <div className="p-4 bg-sky-200">
        <div className="min-h-screen bg-white shadow-2xl rounded-2xl max-w-lg mx-auto">
          <div className="hero-content flex-col ">
            <div className="text-center lg:text-left">
              <h1 className="text-3xl font-bold text-center text-gray-600">
                <span className="text-ferris-prim">Ferris </span>Login
              </h1>
              <img
            ...
            <div className="card flex-shrink-0 w-full px-10">
              <form onSubmit={handleLogIn} className="card-body">
                ...
                <div className="form-control mt-6">
                  <button className="btn  text-white border-none bg-ferris-prim hover:bg-ferris-ter">
                    Login
                  </button>
                </div>
